...
CREATE TABLE IF NOT EXISTS `Article` (
  ...
  `date_parution_Article` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(1, 'Ceci est un test', '2015-11-23 18:47:42', 'Ceci est un nom', 1, 1, 1);
...
(1, '2015-11-21 16:44:03', 1),
(2, '2015-11-21 16:47:36', 1),
(3, '2015-11-21 17:00:28', 1);
...
CREATE TABLE IF NOT EXISTS `Utilisateur` (
  ...
  `Date_Utilisateur` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(1, '2015-11-21 16:22:08', '65829e542dd151f443cc997270c61e78c042a82d687cc13844bf2c1813714600', 'test@mail.tld', '');
